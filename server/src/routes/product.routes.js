...
router.post("/getwallet",verifyToken, authorizeRoles("admin"), productController.getWalletAddress);//get wallet address
...
router.get("/trading", verifyToken, authorizeRoles("user"), productController.trading); // get all assets for sale  
